  ...
  if (state.phase === "idle" || state.phase === "loading") {
    return (
      <div className="studio">
        ...
        <div className="slipcase min-h-[var(--case-min)] w-[460px] max-w-full">
          ...
          <div className="flex grow flex-col items-center px-6 pt-7 pb-4 text-center">
            <div className="flex grow flex-col items-center justify-evenly gap-3">
          ...
          <div className="case-open-only" inert={settled}>
            <div className="px-7 pt-4 pb-4">
              ...
              <div className="mt-4 flex items-end justify-between gap-4">
                <p className="small-print max-w-[38ch]">
